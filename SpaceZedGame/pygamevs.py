...
SSW, SSH = 50, 45
YELLOW_SS_IMG = pygame.image.load('Assetsvs\spaceship_yellow.png')
RED_SS_IMG = pygame.image.load('Assetsvs\spaceship_red.png')
...
BULLET_FIRE_SOUND = pygame.mixer.Sound('Assetsvs\Gun+Silencer.mp3')
BULLET_HIT_SOUND  = pygame.mixer.Sound('Assetsvs\export_ofoct.com.mp3')
CANNON_FIRE_SOUND = pygame.mixer.Sound('Assetsvs\14_7s_Tank_Fire_Shot_Sound_Effects_All.mp3')

HP_FONT = pygame.font.SysFont('segoeui', 40)
WINNER_FONT = pygame.font.SysFont('corbel', 80)

SPACE = pygame.transform.scale(pygame.image.load('Assetsvs\space2.png'), (WIDTH, HEIGHT))
